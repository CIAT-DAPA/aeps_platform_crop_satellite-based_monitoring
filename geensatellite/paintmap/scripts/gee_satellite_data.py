...
from paintmap.scripts import s2_functions
from paintmap.scripts import gis_functions
from paintmap.scripts import general_functions
from paintmap.scripts import l8_functions
...
class get_gee_data:
    ...
    @property
    def summary(self):
        df = pd.DataFrame({'dates': self.dates,
